...
import { caprasimo, vibur, pacifico } from "../app/layout"
    ...
    return (
        <div className="fixed w-full h-32 bg-customColorOliver shadow-lg top-0 left-0 rounded-md content-center z-10">
            <div className="flex justify-between items-center lg:px-20 px-10 text-white font-bold ">
                ...
                <div className="text-customColorFlamingo flex flex-col items-center justify-center text-3xl md:text-4xl gap-0">
